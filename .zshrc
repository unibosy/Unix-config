...
alias gocl='cd /home/unibosy/CLionProjects'
...
#    . /etc/bash_completion
#fi
export PATH=$PATH:/usr/local/curl/bin:/opt/codesourcery/arm/bin:/opt/mipssde/bin:/usr/local/git/bin:/usr/bin/cscope:/bin:/usr/bin:/usr/local/bin:/home/unibosy/:/opt/gradle/gradle-3.4.1/bin:/home/unibosy/Downloads/maven/apache-maven-3.5.3:/usr/bin:/bin:/usr/local/bin:
